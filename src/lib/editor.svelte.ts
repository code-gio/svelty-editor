...
import type { EditorOptions, ToolsLoadMap, EditorTool, EditorChangeEvent } from './types.jsxs';
...
export class EditorManager {
	...
	async registerTool(name: string, toolLoader: () => Promise<any>, config?: Partial<EditorTool>) {
